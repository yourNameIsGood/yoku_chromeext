chrome.tabs.query({'active': true, 'windowId': chrome.windows.WINDOW_ID_CURRENT},
   function(tabs){
      ...
      //点击debug button 在url最后追加debug参数
      ...
      //测试数据：
      var list_data = [
                  {'list_name':'边看边买, 钟伟弹弓','num_id':'319477320',"encode_id":'XMTI3NzkwOTI4MA=='},
                  {'list_name':'边看边买, 药瓶','num_id':'177428936',"encode_id":'XNzA5NzE1NzQ0'},
